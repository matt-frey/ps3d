...
class iso_surface
    ...
    def show(self, step, niso):
        vmag = self.nc_reader.get_dataset(step=step, dataset='vorticity_magnitude')
        vmag = vmag ** 2
        vmin = vmag.min()
        vmax = vmag.max()
    ...
    def export(self, file_path, file_name):
        ...
        # get extension
        _, ext = os.path.splitext(file_name)[1]
        if ext == 'png':
            ...
            print("The " + ext.toUpper() + " file format is not supported.")
    ...
    def _set_basic_render_view(self):
        ...
        self._render_view.CenterAxesVisibility = 1
    ...
    def _create_programmable_filter(self):
        ...
        self._prog_filter.Script = """import numpy as np
    ...
    def _create_contours(self, vmin, vmax, niso):
        ...
        self._contour_display.SetScalarBarVisibility(renderView1, True)
        ...
        self._lut.ApplyPreset('MyRainbow', True)
